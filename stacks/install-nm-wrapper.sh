...
# OctoPrint network plugin: NM wrapper access (read + DHCP/static config write).
$OCTOPRINT_USER ALL=(root) NOPASSWD: $WRAPPER_DST status, $WRAPPER_DST read, $WRAPPER_DST save-wifi-dhcp, $WRAPPER_DST save-wifi-static
SUDOERS
